...
│   │   ├── planning.py .. la grille EFFECTIVE : les périodes fusionnées d'une journée ou d'un intervalle
...
│   │   └── web/ ......... api.py (la surface publique, votes compris) · playout_api.py (les routes de Liquidsoap) · views.py · templates/ · static/ (Vue vendu, la feuille de style, icônes et manifeste PWA)
